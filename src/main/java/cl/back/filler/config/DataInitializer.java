...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Al encenderse la app, si la BD está vacía, mete los memes
        if (perfilRepository.count() == 0) {
           perfilRepository.save(new WaifuHusbando(null, "Shrek", "Shrek (El anime)", "A donde está mi Fiona para soplarle el sapo.", "https://i.imgur.com/dJi55Or.jpeg", 8));
            ...
            perfilRepository.save(new WaifuHusbando(null, "Franky", "One piece", "Si no crees en el corazón de las cartas, dale a la izquierda.", "https://i.imgur.com/VAdKzeg.png", 2));
